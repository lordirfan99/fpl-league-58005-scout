...
export default async function NowPage() {
  ...
  return <div className="page-stack now-workspace">
    ...
    <section className="surface"><div className="section-heading"><div><span>WHAT NEXT</span><h2>{locked ? "Live review only" : "Build or verify your squad"}</h2><p>{locked ? "Use the live workspace for points and rank movement. The next candidate starts after finalization." : "Use Squad Builder for Wildcard, Free Hit and manual what-if planning. It never submits to FPL."}</p></div></div><div className="workspace-links"><Link href="/builder">Open Squad Builder</Link><Link href="/live">Open Live review</Link><Link href="/journal">Open journal</Link></div></section>
