...
export function TransferDraft({ squad, players, teams, gameweek }: { squad: SquadPick[]; players: Player[]; teams: Team[]; gameweek: number }) {
  ...
  const pointDelta = selectedOut && selectedIn ? Number(selectedIn.ep_next) : null;
